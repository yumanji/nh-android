...
public class AnswerWinAdapter  extends BaseAdapter implements SpinnerAdapter{
    private Activity activity;
    private List<AnswerWinItem> list; 

    public AnswerWinAdapter(Activity activity, List<AnswerWinItem> list){
    ...
    public AnswerWinItem getItem(int position) {
