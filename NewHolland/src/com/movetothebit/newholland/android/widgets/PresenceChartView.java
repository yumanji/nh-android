...
public class PresenceChartView extends DemoView {
     ...
     * @param context
     */
    public PresenceChartView(Context context, AttributeSet att) {
        super(context, att);
...
//        String series3 = "Third";
    ...
    private static AFreeChart createChart(CategoryDataset dataset) {
        ...
        AFreeChart chart = ChartFactory.createBarChart(
            "Penetracion de mercado",      // chart title
            "",               // domain axis label
            "%",                  // range axis label
            dataset,                  // data
      ...
      //  GradientColor gp1 = new GradientColor(Color.GREEN, Color.rgb(0, 64, 0));
        ...
        renderer.setSeriesPaintType(1, gp2);
